...
import type { ServerActionResponse, PatientProfile } from "@/types"; // 按你项目路径改
import { prisma } from "@/lib/prisma"; // 按你项目路径改
import { getServerSession } from "next-auth";
import { authOptions } from "@/lib/auth"; // 按你项目路径改

// 如果你是 next-auth v5（Auth.js）体系，通常是：
