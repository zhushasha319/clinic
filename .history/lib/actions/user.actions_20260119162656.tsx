...
export async function signInWithCredentials(
  ...
  try {
    ...
    console.log(
      "[signInWithCredentials] Calling signIn with callbackUrl:",
      callbackUrl,
    );
    ...
    console.log("[signInWithCredentials] Sign in successful, redirecting to:", callbackUrl);
...
export async function signUp(
  ...
  try {
    ...
    console.log("[signUp] Sign up successful, redirecting to:", callbackUrl);
    redirect(callbackUrl);
  } catch (error: unknown) {
