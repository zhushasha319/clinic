...
async function main() {
  ...
  try {
    ...
    if (drAlice && drBob && drCarol) {
      ...
      console.log(`✅ ${doctorProfilesWithRealIds.length} Doctor Profiles seeded successfully`);
    } else {
    ...
    if (drAlice && johnDoe) {
      ...
      console.log(`✅ ${appointmentsWithRealIds.length} Appointments seeded successfully`);
    } else {
