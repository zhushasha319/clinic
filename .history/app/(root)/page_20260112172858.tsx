  ...
  return(
    <div>
     <DynamicBanner></DynamicBanner>
      <div className="flex flex-col p-8 max-w-7xl mx-auto w-full gap-16"><div> <p className="mt-4 mb-12 body-regular text-text-body-subtle max-w-3xl mx-auto text-center">
     ...
     <DepartmentsSection></DepartmentsSection></div>
     
     <OurDoctors></OurDoctors>
     <PatientTestimonials></PatientTestimonials></div>
